...
Added support for Node 14.x, as of October 27th the current LTS version.  iModel.js now supports Node >10.16, 12.x, and 14.x.

> Note: Node 10 support will be dropped the next major release of iModel.js, 3.0.
